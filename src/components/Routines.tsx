                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <ExerciseMenu
                                                                ...
                                                                onMoveToRoutine={targetRoutineId => {
                                                                    if (targetRoutineId === routine.id) return;
                                                                    const exerciseToMove = ex;
                                                                    setRoutines(prevRoutines => {
                                                                        ...
                                                                        // Add to target
                                                                        const targetIdx = updated.findIndex(r => r.id === targetRoutineId);
                                                                        if (targetIdx !== -1) {
                                                                ...
                                                                onCopyToRoutine={targetRoutineId => {
                                                                    if (targetRoutineId === routine.id) return;
                                                                    // Copy exercise (new id, no history)
                                                                    const { id, ...rest } = ex;
                                                                    const exerciseCopy = { ...rest, id: Math.random().toString(36).substr(2, 9) };
                                                                    setRoutines(prevRoutines => {
                                                                        const updated = prevRoutines.map(r => {
